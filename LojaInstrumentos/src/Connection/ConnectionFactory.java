...
public class ConnectionFactory {
    ...
    private String nomeDoBanco = "centralMusic";
    ...
    public ConnectionFactory(String pServidor, String pNomeDoBanco, String pUser, String pPass){
    ...
    public Connection conectar(){
        ...
        //    Class.forName("com.mysql.jdbc.Driver").newInstance();
            ...
            String url = "jdbc:mysql://localhost:3306/centralMusic";
